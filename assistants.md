...
- **Do not search mathlib unless explicitly asked.** When the user asks to state a lemma, just do it — do not preemptively check if it already exists in mathlib. The user will ask "is X formalized?" or "search mathlib for X" when they want a search.
