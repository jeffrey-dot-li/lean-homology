...
| [`api/fin-succabove.md`](api/fin-succabove.md) | `succAbove_succAbove_comm` master lemma, face/degeneracy hole-peeling via `exists_succAbove_eq`, `castPred`-not-`castLT` in `change`, trailing-`rfl` on proof-term mismatch |
